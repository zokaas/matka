      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-0 left-0 w-full">
          <svg viewBox="0 0 1200 300" className="w-full h-auto opacity-10">
            ...
            <polygon points="0,300 0,200 150,120 300,180 450,100 600,140 750,80 900,120 1050,90 1200,130 1200,300" fill="currentColor" className="text-blue-400"/>
            <polygon points="0,300 100,250 250,200 400,230 550,180 700,210 850,170 1000,200 1150,160 1200,180 1200,300" fill="currentColor" className="text-blue-300"/>
            <polygon points="0,300 200,280 350,240 500,260 650,220 800,240 950,200 1100,220 1200,210 1200,300" fill="currentColor" className="text-blue-200"/>
          </svg>
        </div>
        ...
        >
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-yellow-600 to-blue-600 bg-clip-text text-transparent mb-2">
        ...
        >
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-yellow-500 to-blue-500 text-white py-4 px-6 rounded-xl hover:from-yellow-600 hover:to-blue-600 transition duration-200 font-medium flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
        ...
        >
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
            <h3 className="text-sm font-semibold text-blue-800 mb-2 flex items-center justify-center">
