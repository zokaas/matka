...
import { ColorProps, FlexboxProps, LayoutProps, PositionProps, SpaceProps, TypographyProps } from "styled-system";
...
export type StyledModalProps = ColorProps & FlexboxProps & LayoutProps & PositionProps & SpaceProps & CommonModalDialogProps & {
    className?: string;
    variant: "default";
    style: ModalDialogOverlayProps;
};
export type StyledModalPropsWithTheme = StyledModalProps & AppThemeProps;
export type StyledTitleProps = ColorProps & FlexboxProps & LayoutProps & SpaceProps & TypographyProps & {
    variant: "default";
    children: ReactNode;
};
...
export type ModalProps = DefaultModalTitleProps & DefaultModalCloseIconProps & DefaultModalProps & TitleTextStyle;
