...
export function mapKycParamsFromData(
    ...
    return {
        ...
        clientId,
        kycType: "onboarding",
        company: { companyName: name, orgNumber: organizationNumber, sniCode },
        session: {
            kcUserId,
            sessionId,
