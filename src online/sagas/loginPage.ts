...
import { getApplicantSsnFromApplication, history } from "../utils";
...
function* handleApplicationFlow(token: string) {
    ...
    if (applicationChannel === E_ApplicationChannel.BROKER) {
        ...
        // TODO: call the redirect helper / initiate KYC with session
        // yield call(initiateKycFlowWithSession, organizationNumber, companyName);
        return;
    }
