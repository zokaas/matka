...
const breakpoints = ["786px", "1080px"];
const colorPalette = {
...
const sizes = ["8px", "12px", "14px", "16px", "18px", "20px", "24px", "32px"];
const fontMargins = ["0", "8px", "18px", "20px", "22px", "24px", "32px"];
const fontPaddings = ["0", "8px", "18px", "0", "22px", "24px", "0"];
const fonts = {
    basic: "arial",
};
exports.theme = {
