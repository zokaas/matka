...
exports.startPageApplyForLoan = startPageApplyForLoan;
exports.startPageApplyForLoanLink = startPageApplyForLoanLink;
const __1 = require("..");
...
function startPageApplyForLoan() {
    return {
        display: "flex",
        fontSize: general_1.E_Fonts.SMALLEST_FONT_SIZE,
        padding: 0,
        marginBottom: "10px",
        fontFamily: general_1.E_Fonts.FONT_FAMILY,
        color: general_1.E_Fonts.BASIC_FONT_COLOR,
...
function startPageApplyForLoanLink() {
    return Object.assign(Object.assign({}, startPageApplyForLoan()), { textDecoration: "underline", cursor: "pointer", ":hover": {
            color: "#0056b3",
        }, marginLeft: "2px" });
}
//# sourceMappingURL=nlStartPage.js.map