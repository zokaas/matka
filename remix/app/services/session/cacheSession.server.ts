import { createCookie, createSessionStorage, Session } from "react-router";
...
export const getSessionProps = <K extends keyof T_SessionData>(
    session: Session<T_SessionData, T_SessionData>,
    ...keys: K[]
): { [P in K]: T_SessionData[P] | null } => {
    const data = session.data;

    const result = {} as { [P in K]: T_SessionData[P] | null };
