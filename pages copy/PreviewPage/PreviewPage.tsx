...
import { applicationAppActions } from "../../actions/index.actions";
...
function PreviewPage() {
    ...
    const { isPosted } = useSelector((state: T_GlobalState) => {
    ...
    const handleSubmitApplication = async () => {
        ...
        try {
            ...
            dispatch(applicationAppActions.postApplicationRequest(mappedData));
            setErrorCounter(0);
            pushDatalayerEvent();
        } catch (error) {
            handleError();
