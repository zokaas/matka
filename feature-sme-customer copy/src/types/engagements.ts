...
export enum E_EngagementActionConstants {
...
export type T_EngagementBusinessIndividual =
    VP.components["schemas"]["BusinessIndividualEngagement"];

export type T_EngagementConsumerAccount = VP.components["schemas"]["ConsumerAccountEngagement"];

export type T_EngagementConsumerApplication =
    VP.components["schemas"]["ConsumerApplicationEngagement"];

export type T_EngagementConsumerOrigination =
    VP.components["schemas"]["ConsumerOriginationEngagement"];
